  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="font-medium text-orange-500">Routine</span>
            <span className="text-xs text-zinc-400">Standard Report</span>
          </div>
        </button>
      </div>
          ...
          {image ? (
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-zinc-400">
                Upload an image by dropping it here or clicking to select
              </p>
            </div>
          )}
        </label>
      ...
      <button
        ...
        className="w-full relative group overflow-hidden rounded-xl bg-gradient-to-br from-pink-700 to-purple-700 
                 px-4 py-3.5 text-sm font-medium text-white shadow-lg
                 transition-all duration-200 hover:from-pink-800 hover:to-purple-900
